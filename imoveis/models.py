...
class Imovel(models.Model):
    ...
    CARACTERISTICAS_SCHEMA = {
        Tipo.APARTAMENTO: [
            ...
            {'campo': 'area_pivativa_real',      'label': 'Área Privativa Real',           'tipo': 'decimal',   'obrigatorio': False},
            {'campo': 'area_unidade_construct',  'label': 'Área da Unidade de Construção', 'tipo': 'decimal',   'obrigatorio': False},
        ],
        Tipo.CASA: [
            {'campo': 'quartos',                 'label': 'Quartos',                       'tipo': 'numero',    'obrigatorio': False},
            {'campo': 'banheiros',               'label': 'Banheiros',                     'tipo': 'numero',    'obrigatorio': False},
